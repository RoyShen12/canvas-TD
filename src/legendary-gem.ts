...
class PainEnhancer extends GemBase {
  ...
  static override readonly imgSrc =
  ...
  static override get stasisDescription() {
    return `攻击敌人有 ${this.chance * 100}% 的几率使其流血，在 3 秒内受到 ${Tools.roundWithFixed(this.baseBleedDamageRatio * 100, 1)}% （+${Tools.roundWithFixed(
...
class SimplicitysStrength extends GemBase {
  ...
  override levelUp(currentPoint: number) {
    ...
    if (this.tower) this.tower.__atk_ratio = 1 + this.attackAddition
...
class GogokOfSwiftness extends GemBase {
  ...
  override levelUp(currentPoint: number) {
    ...
    if (this.tower) this.tower.__hst_ps_ratio = 1 + this.hasteAddition
...
class MirinaeTeardropOfTheStarweaver extends GemBase {
  ...
  static override get stasisDescription() {
    return `击中时有 ${this.chance * 100}% 的几率 [重击] 附近的一名敌人，每 ${this.Hst / 1000} 秒 [重击] 一名随机敌人 (需要25级) [重击]: 对目标造成 ${Tools.roundWithFixed(
      this.baseChitDamageRatio * 100,
      1
    )}%（+${Tools.roundWithFixed(this.chitDamageRatioLevelMx * 100, 1)}%/等级）攻击力的伤害`
  }
...
class BaneOfTheStricken extends GemBase {
  ...
  static override get stasisDescription() {
    return `你对敌人造成的每次攻击都会使敌人从你攻击中受到的伤害提高 ${Tools.roundWithFixed(BaneOfTheStricken.baseDamageMakingRatio * 100, 2)}%（+${Tools.roundWithFixed(
      BaneOfTheStricken.damageMakingRatioLevelMx * 100,
      3
    )}%/等级），对首领造成的伤害提高 ${Tools.roundWithFixed(BaneOfTheStricken.damageMakingRatioOnBoss * 100, 0)}%`
  }
  ...
  override levelUp(currentPoint: number) {
    ...
    if (this.tower) this.tower.__on_boss_atk_ratio = 1 + this.damageMakingRatioOnBoss
...
class GemOfEase extends GemBase {
  ...
  override levelUp(currentPoint: number) {
    ...
    if (this.tower) this.tower.__kill_extra_gold = this.goldAddition
...
class GemOfMysterious extends GemBase {
  ...
  override levelUp(currentPoint: number) {
    ...
    if (this.tower) this.tower.__kill_extra_point = this.pointAddition
...
class BaneOfTheTrapped extends GemBase {
  ...
  static override get stasisDescription() {
    return `对受到控制类限制效果影响的敌人造成的伤害提高 ${Tools.roundWithFixed(this.baseDamageMakingRatioOnTrapped * 100, 1)}%（+${Tools.roundWithFixed(
  ...
  override levelUp(currentPoint: number) {
    ...
    if (this.tower) this.tower.__on_trapped_atk_ratio = 1 + this.damageMakingRatioOnTrapped
...
class ZeisStoneOfVengeance extends GemBase {
  ...
  static override get stasisDescription() {
    return `你和命中的敌人间隔越远，造成的伤害就越高，最少提高 ${Tools.roundWithFixed(this.baseDamageMakingRatioMin * 100, 2)}%（+${Tools.roundWithFixed(
      this.damageMakingRatioLevelMxMin * 100,
      2
    )}%/等级），在最远射程时提高 ${Tools.roundWithFixed(this.baseDamageMakingRatioMax * 100, 2)}%（+${Tools.roundWithFixed(this.damageMakingRatioLevelMxMax * 100, 2)}%/等级），击中时有 ${
      this.chance * 100
  ...
  override levelUp(currentPoint: number) {
    ...
    if (this.tower) this.tower.__min_rng_atk_ratio = this.damageMakingRatioMin
    if (this.tower) this.tower.__max_rng_atk_ratio = this.damageMakingRatioMax
...
class EchoOfLight extends GemBase {
  ...
  static override get stasisDescription() {
    return `对敌人造成非神圣伤害时会在 ${this.duration / 1000} 秒内造成相当于这次伤害 ${Tools.roundWithFixed(this.baseExtraTotalDamageRatio * 100, 1)}%（+${Tools.roundWithFixed(
...
class BrokenPieces extends GemBase {
  ...
  static override get stasisDescription() {
    return (
      `每次击中都能摧毁敌人 ${Tools.roundWithFixed(this.baseArmorDecreaseStrength * 100, 1)}%（+${Tools.roundWithFixed(this.armorDecreaseStrengthLevelMx * 100, 2)}%/等级）的护甲，` +
